...
if there are more than 50 transactions in the transaction pool assume we are having connection problems with the current staker\textquotesingle{}s node and remove that staker from the stakers vector.
