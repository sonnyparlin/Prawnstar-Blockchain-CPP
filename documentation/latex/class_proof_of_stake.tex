...
{\footnotesize\ttfamily uint32\+\_\+t Proof\+Of\+Stake\+::fnv1a_hash (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{text }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}
